# Image 29: 6ca46601-3d84-4b4c-a26e-4f19295ffcb6.jpg

Original: ../6ca46601-3d84-4b4c-a26e-4f19295ffcb6.jpg

![Original](../6ca46601-3d84-4b4c-a26e-4f19295ffcb6.jpg)

## Summary

A photo of a computer screen showing a Markdown/knowledge base document containing a security and permissions test case table (安全与权限 测试用例).

## OCR in reading order

7.1新增功能与测试用例对照表
测试用例
01_测试用例 / 10_安全与权限 / 测试用例
参考文档
• 代码: src/core/syscmd/blockdev/, server/server.go, src/http/
• 交接文档: 05_参考资料/PRD/7.1交接聊天记录与问题等.md §2, §7
测试用例
...
SEC-004 安全与权限 密码不泄露到命令行 (stdin 传递码) P0 ① 可创建加密卷 ① 格式化加密卷；② ps aux \| grep cryptsetup 检查进程命令行 ① 密码不出现在 ps 输出中；② 密码不出现在 shell 历史中 7.1 cryptsetup 密码改 stdin
...
- Scene: computer screen document
- Intent: 
...
- Verification: GPT native image review; original image kept local.\r\n- JSON: D:/test_dev_projects/storagemanager/7.1/新增功能与用例/照片/提取md/json/6ca46601-3d84-4b4c-a26e-4f19295ffcb6.json
