# ui_automation/config/settings.py - UI 自动化模块配置管理
"""
UI 自动化模块专属配置管理器：
...
class Settings:
    ...
    def browser(self) -> dict:
        """浏览器配置（type / headless / implicit_wait / page_load_timeout）"""
    ...
    def __repr__(self) -> str:
        return f"<UI Settings env='{self.env}' base_url='{self.base_url}'>"
